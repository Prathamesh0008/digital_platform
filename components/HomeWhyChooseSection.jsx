...
export default function HomeWhyChooseSection() {
  ...
  // Alternate image side: index 0 -> right, index 1 -> left, index 2 -> right
  const isImageOnRight = activeInfoTab !== 1;
  const activeInfo = infoTabs[activeInfoTab];
 
  const imageColumn = (
  <div className={`order-2 overflow-hidden rounded-[36px] border border-white/30 bg-white/20 p-3 backdrop-blur-md ${
  ...
  const contentColumn = (
    <div className={`order-1 rounded-2xl bg-white/15 p-6 backdrop-blur-sm sm:p-8 ${
      isImageOnRight ? "lg:order-1" : "lg:order-2"
    }`}>
      ...
      <div className="hidden space-y-4 lg:block">
        <h3 className="text-2xl font-semibold uppercase tracking-tight text-black sm:text-3xl">
          {activeInfo.title}
        </h3>
  ...
  const mobileTextColumn = (
    <div className="order-3 rounded-2xl bg-white/15 p-6 backdrop-blur-sm sm:p-8 lg:hidden">
      <h3 className="text-2xl font-semibold uppercase tracking-tight text-black sm:text-3xl">
        {activeInfo.title}
      </h3>
  ...
  <div className="h-[420px] overflow-hidden rounded-[28px] sm:h-[480px] lg:h-[560px]">
    ...
    />
        ...
        {/* Interactive Info Section with Alternating Image Position */}
        <div className="mt-16 border-l border-black/15 pl-4 sm:pl-6 md:mt-24 md:pl-10">
