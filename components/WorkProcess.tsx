        ...
        <div className="relative mx-auto mt-16 hidden h-[820px] max-w-[1350px] lg:block">
          ...
          {steps.map((step, idx) => (
            ...
            >
              ...
              <div
                className={`mt-5 flex min-h-[230px] flex-col justify-start rounded-2xl border border-[#0d2d47]/10 bg-[#B6C4E7] p-5 font-[family:var(--font-inter)] shadow-[0_18px_40px_rgba(13,45,71,0.14)] transition-all duration-700 ${
                  glowStates[idx]
              ...
              >
                <h3
                  className="text-[28px] text-2xl font-normal leading-[1.1] text-[#0d2d47]"
                >
                  {step.title}
                </h3>

                <p className="mt-4 text-xl leading-relaxed text-[#0d2d47]/75">
                  {step.text}
                </p>
              </div>
            </div>
