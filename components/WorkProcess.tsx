            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-14 flex min-h-[240px] w-[calc(100%-56px)] flex-col items-center justify-center rounded-[24px] border border-[#0d2d47]/10 bg-[#B6C4E7] p-5 text-center shadow-[0_18px_40px_rgba(13,45,71,0.14)] sm:ml-0 sm:min-h-[260px] sm:w-[43%]">
  <h3
