      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 md:px-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:gap-14">
          ...
          <div className="h-fit pl-0 sm:pl-4 md:pl-10 lg:pt-2">
            <h2 className="hidden max-w-[260px] text-[3rem] font-semibold uppercase leading-[0.9] tracking-tight text-black sm:block sm:max-w-none sm:text-5xl md:text-[62px] lg:text-[78px]">
              Build              Your
              <br />
              Brand
            </h2>
