...
export default function AboutTeam() {
  ...
  const TeamCard = ({ member }) => (
    <div className="group w-[280px] shrink-0 cursor-pointer md:w-auto">
      ...
      <div className="mt-4 h-[2px] w-0 bg-[#5A7EFF] transition-all duration-300 group-hover:w-full" />
    </div>
  );

  return (
    <section className="relative w-full overflow-hidden bg-[#EAEBDB] px-4 py-20 sm:px-6 sm:py-28 md:px-10 md:py-40">
