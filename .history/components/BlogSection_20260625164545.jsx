    ...
    <section className="relative overflow-hidden bg-[#7A97F8] px-4 py-12 sm:px-6 md:px-10 md:py-14">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        <div className="mb-8 border-b border-[#0d2d47]/14 pb-6">
          <div className="grid gap-4 md:grid-cols-[320px_minmax(0,1fr)] md:items-end md:gap-6 lg:grid-cols-[360px_minmax(0,720px)]">
            <h2 className="max-w-[320px] text-4xl font-semibold uppercase leading-[0.92] tracking-tight text-[#0d2d47] sm:text-5xl md:text-[56px]">
              Latest
              <br />
              Blogs
            </h2>

            <p className="max-w-xl text-sm leading-7 text-[#0d2d47]/78 sm:text-base md:text-lg">
