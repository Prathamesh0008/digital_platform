...
<section className="relative min-h-[78svh] w-full overflow-hidden md:h-screen">
      ...
      <div className="pointer-events-none top-5 relative z-40 flex h-full flex-col items-center justify-center px-5 py-20 text-center text-white sm:px-6 md:px-6 md:py-0">
